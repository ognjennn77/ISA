INSERT INTO `isa`.`cinematheatre` (`name`,`description`,`address`,`rating`,`cinema`,`repertory_id`) VALUES ( 'CineStar','odlican','Ise Bajica 5','5',1,'4');

INSERT INTO `isa`.`cinematheatre` ( `name`,`description`,`address`,`rating`,`cinema`,`repertory_id`) VALUES ( 'Srpsko Narodno pozoriste','dobar','Marije Magdalene 6','3',0,'3');  
INSERT INTO `isa`.`cinematheatre` (`name`,`description`,`address`,`rating`,`cinema`,`repertory_id`) VALUES ( 'Umetnicko pozoriste','srednje','Bulevar Oslobodjenja 100','3',0,'1');
INSERT INTO `isa`.`cinematheatre` ( `name`,`description`,`address`,`rating`,`cinema`,`repertory_id`) VALUES ( 'Bioskop','vrlo dobar','Mihajla Pupina 11','4',1,'2');
