...
INSERT INTO `isa`.`seat` (`id`, `ordinal`, `reserved`) VALUES ('3','3',1);
...
INSERT INTO `isa`.`seat` (`id`, `ordinal`, `reserved`) VALUES ('12','4',1);
INSERT INTO `isa`.`seat` (`id`, `ordinal`, `reserved`) VALUES ('13','5',1);
...
INSERT INTO `isa`.`reservation_seats` (`reservation_id`, `seats_id`) VALUES ('2','12');
INSERT INTO `isa`.`reservation_seats` (`reservation_id`, `seats_id`) VALUES ('2','13');
INSERT INTO `isa`.`reservation_seats` (`reservation_id`, `seats_id`) VALUES ('3','3');
